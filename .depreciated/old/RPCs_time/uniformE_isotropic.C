...
int main(int argc, char *argv[]){
	...
	if (argc<10){
		...
		cout<<"./fatGem rootFileName.root fieldE(V/cm) pitch(mm) pressure(bar) npe(#) gas1() mixture(%) gas2() mixture(%) height(0.9 to 0.999) time_fixed"<<endl;
		exit(EXIT_FAILURE);
	}
	...
	// Pasamos 
	TString _time0 =argv[11];
	double t_fixed = _time0.Atof();
	...
	// Definimos temperaturasimulación
	...
	dataPerPrimaryElectron->Branch("nElectrons_time_fixed", &ne_time_fixed,"nElectrons_time_fixed/I");  
